...
from bunji.managers import categories
...
def test_create_category(test_db):
    # Test data
    category_data = {"name": "Test Category", "nature": Nature.WANT, "color": "#FF0000"}
...
def test_create_subcategory(test_db):
    ...
    parent_data = {"name": "Parent Category", "nature": Nature.NEED, "color": "#00FF00"}
...
def test_get_categories_count(test_db):
    ...
    category_data1 = {"name": "Category 1", "nature": Nature.WANT, "color": "#FF0000"}
    category_data2 = {"name": "Category 2", "nature": Nature.NEED, "color": "#00FF00"}
...
def test_get_all_categories_tree(test_db):
    ...
    parent_data = {"name": "Parent", "nature": Nature.NEED, "color": "#FF0000"}
    parent = categories.create_category(parent_data)
