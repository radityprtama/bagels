...
from bunji.managers import accounts
...
def test_get_all_accounts(test_db):
    # Create test data
    account_data1 = {"name": "Account 1", "beginningBalance": 1000.0, "hidden": False}
    account_data2 = {"name": "Account 2", "beginningBalance": 2000.0, "hidden": True}
...
def test_get_account_by_id(test_db):
    # Create test data
    account_data = {"name": "Test Account", "beginningBalance": 1000.0, "hidden": False}
    new_account = accounts.create_account(account_data)
